...
function App() {
  ...
  return (
    <>
      <div className="w-full h-100 px-2 sm:px-0">
        <div className="w-full max-w-sm sm:max-w-xl lg:max-w-3xl mx-auto shadow-md rounded-lg px-4 py-3 my-12 text-orange-500 bg-gray-800">
          ...
          <div className="flex flex-col sm:flex-row shadow rounded-lg overflow-hidden mb-6">
            ...
            />
            <button
              className="outline-none bg-[#0B60B0] lg:hover:bg-green-700 text-white px-3 py-0.5 shrink-0"
          ...
          <div className="flex flex-col sm:flex-row text-sm gap-x-5">
